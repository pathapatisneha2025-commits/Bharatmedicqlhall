...
{validationErrors.breakOut && <Text style={styles.error}>{validationErrors.breakOut}</Text>}
  ...
  <TouchableOpacity style={styles.loginButton} onPress={() => navigation.navigate('EmpLogin')}>
...
const styles = StyleSheet.create({
  ...
  loginButton: { backgroundColor: '#007BFF', paddingVertical: 12, paddingHorizontal: 20, borderRadius: 8, alignItems: 'center', marginTop: 15 },
