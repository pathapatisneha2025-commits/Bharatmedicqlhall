...
<View style={[styles.inputWrapper, { width: isLargeScreen ? '48%' : '100%' }]}>
                  <TextInput style={styles.input} placeholder="Full Nmae" value={fullName} onChangeText={setFullName} />
                </View>
...
<View style={[styles.inputWrapper, { width: isLargeScreen ? '48%' : '100%' }]}>
                  <TextInput style={styles.input} placeholder="12-digit Adhar number" value={aadhar} onChangeText={setAadhar} keyboardType="numeric" maxLength={12}/>
                    {validationErrors.aadhar && <Text style={styles.error}>{validationErrors.aadhar}</Text>}

                </View>

<View style={[styles.inputWrapper, { width: isLargeScreen ? '48%' : '100%' }]}>
                  <TextInput style={styles.input} placeholder="ABCDE1234F PanNumber" value={pan} onChangeText={setPan} autoCapitalize="characters" />
...
<View style={[styles.inputWrapper, { width: isLargeScreen ? '48%' : '100%' }]}>
              ...
              <View style={styles.agreeRow}>
                ...
                <Text style={styles.agreeText}>I agree to Bharat Medical Hall terms and conditions</Text>
              </View>
              {validationErrors.agree && <Text style={styles.errorText}>{validationErrors.agree}</Text>}

              <TouchableOpacity style={styles.submitBtn} onPress={handleRegister}>
                <Text style={styles.submitBtnText}>Register Now</Text>
              </TouchableOpacity>

              <TouchableOpacity onPress={() => navigation.navigate('EmpLogin')} style={styles.loginLink}>
