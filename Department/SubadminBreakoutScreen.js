...
import { getSubadminId } from '../utils/storage'; // ✅ use subadmin ID
...
const SubadminBreakOutScreen = () => {
  ...
  // ✅ Fixed Office Location (update as needed)
 ...
 const endBreak = async () => {
  ...
  try {
    ...
    if (data.success) {
      ...
      Alert.alert('✅ Success', data.message || 'Break ended successfully!');
    } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Subadmin Break Out</Text>
        <View style={{ width: 28 }} />
      </View>
