...
export default function AdnminAddDoctor({ navigation }) {
  ...
  if (loading) {
    return (
      <View style={styles.loaderContainer}>
        ...
        <Text style={{ marginTop: 10 }}>Loading docotrs...</Text>
      </View>
    );
  }
...
<View style={styles.inputContainer}>
  ...
  />
        ...
        <TouchableOpacity style={styles.button} onPress={handleRegister} disabled={loading}>
          {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.buttonText}>Add Doctor</Text>}
        </TouchableOpacity>
